...
class Box(Shape):
    ...
    def x_subsumes(self, small_box):
        return self.xmin <= small_box.xmin <= small_box.xmax <= self.xmax

    def y_subsumes(self, small_box):
        return self.ymin <= small_box.ymin <= small_box.ymax <= self.ymax
