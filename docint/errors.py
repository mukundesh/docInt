...
class Errors:
    ...
    E002 = ("Can't write to frozen dictionary. This is likely an internal "
            "error. Are you writing to a default function argument?")
    E003 = ("Can't write to frozen list. This is likely an internal "
            "error. Are you writing to a default function argument?")
    ...
    E009 = ("Can't restore disabled pipeline component '{name}' because it "
