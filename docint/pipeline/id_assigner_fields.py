...
class IDAssignerMultipleFields:
    ...
    def search_officer_id2(self, officer, name_nows, cutoff):
        ...
        def get_date_officer_id(mat_officers, dob):
            ...
            assert len(ex_mat_officers) in (0, 1), f'{",".join(details(o) for o in ex_mat_officers)}'
            ...
            assert len(inv_mat_officers) in (0, 1), f'INV: {",".join(o.name for o in inv_mat_officers)}'                        
            ...
            assert len(lev_mat_officers) in (0, 1), f'INV: {",".join(o.name for o in lev_mat_officers)}'                        
