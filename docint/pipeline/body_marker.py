...
class FindBodyMarker:
    ...
    def __call__(self, doc):
        ...
        doc.add_extra_page_field("list_items", ("list", "docint.para", "Para"))
        ...
        body_labels = first_page.word_labels.get("ORDERBODY", [])
        page_idxs = body_labels["page_idx_"]
        ...
        body_marker = Para.build_with_lines(body_marker_words, bm_lines)
